package com.techlab.ecommerce.inventory.messaging;
...
/**
 * Builds Inventory Service event envelopes. For message-driven saga events, the
...
public class EventEnvelopeFactory {
    ...
    public static final String SOURCE_SERVICE = "inventory-service";
